...
<body>
  <div class="form-container">
        <h1 id="form-heading">Update Form</h1>

       <form:form class="form" action="saveUpdatePerson"  method="post" modelAttribute="updateperson">
          <div class="form1">
            ...
            <form:input path="email" type="email" name = "email" required="true" />

            <form:label path="phone">Phone Number:</form:label>
            <form:input path="phone" type="number" name = "phno" required="true" />
